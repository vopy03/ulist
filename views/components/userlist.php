...
foreach ($users as $user) { ?>
  <tr data-id="<?= $user['id'] ?>">
    ...
    <td class="text-nowrap align-middle"><span class="user-role"><?= $roles[$user['role_id']]['name'] ?></span></td>
    ...
    <td class="text-center align-middle">
      <div class="btn-group align-top">
        <button class="btn btn-sm btn-outline-secondary badge edit-user-btn" type="button" data-id="<?= $user['id'] ?>"><i class="fa fa-pencil" data-id="<?= $user['id'] ?>"></i></button>
        <button class="btn btn-sm btn-outline-secondary badge delete-user-btn" data-id="<?= $user['id'] ?>" type="button"><i class="fa fa-trash" data-id="<?= $user['id'] ?>"></i></button>
      </div>
    </td>
  </tr>
<?php } ?>