  ...
  <tr>
    ...
    <td class="text-center align-middle">
      <div class="btn-group align-top">
        <button class="btn btn-sm btn-outline-secondary badge edit-user-btn" type="button" data-id="<?= $user['id'] ?>" data-toggle="modal" data-target="#user-form-modal">Edit</button>
